                        ...
                        <div class="panel-body table-responsive">
                           <table class="table convert-data-table table-striped">
                              ...
                              <tbody class="text-center">
                                 <?php
                                    $i=1;
                                    $stmt=$user->runQuery("select * from meem_jobs where status='expired'");                                         
                                    $stmt->execute();
                                    $data=$stmt->fetchAll();
                                    foreach ($data as $row)
                                    {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="job_list.php?view=job&job_id=<?php echo $row['id'];?>" class="btn btn-sm btn-success" target="_blank">View</a>
                                    </td>
                                 </tr>
                                 <?php $i++; } ?>
                              </tbody>
