...
<html lang="en">
   ...
   <head>
      ...
      <title>MeeM.one Job Portal - Employer Membership renewal</title>
      <!-- Fav Icon -->
   ...
   <body onLoad="submitPayuForm()">
	...
	<div class="my_pack">1 Month Free</div>
 ...
 <div class="get-btn visible-xs"><a href="#" class="btn btn-info btn-sm scrollToTop1">Get Started</a></div>
	...
	<div class="team-front">
	<div class="my_pack2">For 6 Months </div>
	<h3>₹ 1000/-  $ 15</h3>
	</div>
                     ...
                     <div class="panel panel-info" >
                        ...
                        <div style="padding-top:30px" class="panel-body" >
                           ...
                           <form method="post" action="<?php echo $action;?>"   name="payuForm"   class="form-horizontal" role="form"  >
                              ...
                              <input type="hidden" name="surl" value="http://ridaits.com/meemJob/renewal_success.php" />   
                              <input type="hidden" name="furl" value="http://ridaits.com/meemJob/renewal_failure.php" />
                              <input type="hidden" name="productinfo" class="form-control" value="employer-renewal">  
                              <div style="margin-bottom: 25px" class="input-group">
                                 <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                 <input id="login-username" type="text" class="form-control" name="firstname" value="<?php echo  $row['emp_name']; ?>" readonly="" style="border:1px solid #ccc;">                                        
                              </div>
                              <div style="margin-bottom: 25px" class="input-group">
                                 <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                 <input type="text" name="email" class="form-control" value="<?php echo  $row['emp_email']; ?>" readonly="" style="border:1px solid #ccc;">
                              </div>
                              <div style="margin-bottom: 25px" class="input-group">
