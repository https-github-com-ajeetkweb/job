...
$query=$user->runQuery("select verify,emp_name,mobile,mcode,paid from employers_tble where id=:userid  limit 1");
...
$stmt=$user->runQuery("update employers_tble set otp=:user_otp where id=:user_id");
...
<title>MeeM.one Job Portal - Employer Email & Mobile Number verification</title>
...
<div class="clearfix"></div>
  ...
  <div class="col-md-12 ">	
    ...
    <form  method="post" id="otp-form">
                                       ...
                                       <input type="text" class="form-control" name="usercode" maxlength="10" id="usercode" placeholder="Enter Verification code">
                                                    </div>
